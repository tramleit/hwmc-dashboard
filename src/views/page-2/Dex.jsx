...
useEffect(() => {
  if (!tokens || fromToken) console.log("no tokens or fromToken");
  else setFromToken(tokens[nativeAddress]);
}, [tokens, fromToken]);
  ...
  const ButtonState = useMemo(() => {
    ...
    console.log(chainId,`Switch to ${chain}`)
  ...
  return (
    <>
      <Card style={styles.card} bodyStyle={{ padding: "18px" }}>
        ...
        className="btn btn-elevated-warning hover:bg-yellow-500 hover:text-black"
          size="large"
          style={{
            width: "100%",
            marginTop: "15px",
