...
function Main(props) {
  ...
  return (
    <>
      {/* BEGIN: Top Bar */}
      <div className="lg:hidden sm:inline top-bar sticky">
        <div className="w-full xl:w-9/12 2xl:w-11/12 h-full ">
          <Tracker />
        </div>
      </div>    
      {/* BEGIN: Top Bar */}
      <div className="flex rounded-2xl top-bar sticky top-16 justify-between md:top-0" style={{backgroundColor : '#0b0d12'}}>
         <div>
            {/* BEGIN: Search */}
